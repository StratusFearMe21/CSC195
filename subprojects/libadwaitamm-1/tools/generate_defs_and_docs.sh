...
# Generated files:
#   libadwaitamm-1/libadwaita/src/libadwaita_docs.xml
#   libadwaitamm-1/libadwaita/src/libadwaita_enums.defs
#   libadwaitamm-1/libadwaita/src/libadwaita_methods.defs
#   libadwaitamm-1/libadwaita/src/libadwaita_signals.defs
...
if [ -z "$GMMPROC_GEN_BUILD_DIR" ]; then
  GMMPROC_GEN_BUILD_DIR="$GMMPROC_GEN_SOURCE_DIR/../build/subprojects"
fi
...
extra_defs_gen_dir="$GMMPROC_GEN_BUILD_DIR/libadwaitamm-1/tools/extra_defs_gen"
...
if [ "$GMMPROC_GEN_SOURCE_DIR" == "$GMMPROC_GEN_BUILD_DIR" ]; then
  ...
  extra_defs_gen_dir="$GMMPROC_GEN_BUILD_DIR/libadwaitamm-1/build/tools/extra_defs_gen"
fi
